...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String VOCAB_INPUT = "Input_Word";
    private static final String VOCAB_TRANSLATION = "Translation";
    private static final String VOCAB_HINT = "Hint";
    private static final String DATE_TO_REMIND = "Date_To_Remind";
    private static final String TABLE_NAME = "Vocabulary";
    private static final String DAY_WAITS = "Day_Waits";
