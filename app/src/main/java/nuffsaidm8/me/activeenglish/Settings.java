...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView SettingsHeader = findViewById(R.id.settingsHeader);
        SettingsHeader.setTypeface(settingsFace);

        useTrans = findViewById(R.id.checkByTransSwitch);
        reset = findViewById(R.id.resetDayWaitSwitch);
        showWarning = findViewById(R.id.dontShowSwitch);
        Button toChooserButton = findViewById(R.id.customizeDayWaits);
        Button home = findViewById(R.id.homeButtonSettings);
