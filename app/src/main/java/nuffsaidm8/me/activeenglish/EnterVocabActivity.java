...
public class EnterVocabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText wordInput = findViewById(R.id.wordBox);
        EditText translationInput = findViewById(R.id.translationBox);
        EditText hintInput = findViewById(R.id.enterHint);
        Button submitButton = findViewById(R.id.submit);
        Button home = findViewById(R.id.homeButtonEnter);
