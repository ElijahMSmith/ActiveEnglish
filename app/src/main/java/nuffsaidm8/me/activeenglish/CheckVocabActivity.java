...
public class CheckVocabActivity extends AppCompatActivity {
    ...
    private List<Word> checked = new ArrayList<>();
    private boolean useTrans = false;
    private boolean resetAfterMiss = false;
    private boolean hintOn = false;
    private TextView currentWordDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hintDisplay = findViewById(R.id.hintShower);

        Button showHintBtn = findViewById(R.id.showHintBtn);
        Button homeButtonCheck = findViewById(R.id.homeButtonCheck);
