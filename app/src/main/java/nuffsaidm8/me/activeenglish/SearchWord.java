...
public class SearchWord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton trash = findViewById(R.id.trashButtonSearch);
        Button home = findViewById(R.id.homeButtonSearch);
        Button submit = findViewById(R.id.submitchanges);
        Button resetDatesButton = findViewById(R.id.resetDatesButton);
        wordShower = findViewById(R.id.showWord);
        translationShower = findViewById(R.id.showtrans);
        hintShower = findViewById(R.id.showhint);
        searchInput = findViewById(R.id.searchinput);
        dateDisplay = findViewById(R.id.nextDateDisplay);
