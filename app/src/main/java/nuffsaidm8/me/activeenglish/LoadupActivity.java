...
import nuffsaidm8.me.activeenglish.receivers.CheckTime;
...
public class LoadupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView welcomeView = this.findViewById(R.id.welcome);
        TextView selectView = this.findViewById(R.id.selectWhatYouWantToDo);
