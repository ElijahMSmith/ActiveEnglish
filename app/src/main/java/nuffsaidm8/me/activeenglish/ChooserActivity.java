...
public class ChooserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView daysLabel = findViewById(R.id.DaysLabel);
        TextView weeksLabel = findViewById(R.id.WeeksLabel);
        TextView monthsLabel = findViewById(R.id.MonthsLabel);
        TextView yearsLabel = findViewById(R.id.YearsLabel);
        Button homeButtonChooser = findViewById(R.id.homeButtonChooser);
        ImageButton check = findViewById(R.id.doneButton);
        ImageButton trash = findViewById(R.id.trashButton);
        ...
        ImageButton newPageButton = findViewById(R.id.newPageButton);
